...
let from = new Date('2024-01-01T00:00')
let to = new Date('2024-12-31T23:59')

const fromLimit = 1704024000000 // 2023-12-31T12:00:00.000Z
const toLimit = 1735732800000 // 2025-01-01T12:00:00.000Z

if (isNaN(from.getTime()) || from.getTime() < fromLimit) {
  from = new Date(1704067200000) // 2023-01-01T00:00:00.000Z
}

if (isNaN(to.getTime()) || to.getTime() > toLimit) {
  to = new Date(1735689540000) // 2024-12-31T23:59:00.000Z
}
